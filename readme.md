...
You can log into my PYNQ board remotely. If you want to do this, please send me an email so that I can power on the board for you. What you need to do then is to type  **[The IP no.]()**(this will be delievered to you via the email) in the browser (firefox and Chrome recommended) and you will be brought to the log-in page which looks like:
