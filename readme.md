...
| https://github.com/hysun00/BEng-Project-Haoyuan-Sun-UoE/tree/master/overlay            | The python programmes  designed for LeNet-5 inference on SoC are stored in this folder. For more details, please refer to the readme.md in /overlay |
