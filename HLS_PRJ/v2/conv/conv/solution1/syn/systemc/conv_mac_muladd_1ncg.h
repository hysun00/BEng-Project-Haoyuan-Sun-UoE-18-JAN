...
// ==============================================================
#ifndef __conv_mac_muladd_1ncg__HH__
#define __conv_mac_muladd_1ncg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mac_muladd_1ncg) {
    ...
    SC_CTOR(conv_mac_muladd_1ncg):  simcore_mac_2_U ("simcore_mac_2_U") {
