...
// ==============================================================
#ifndef __conv_sdiv_19s_9nsbkb__HH__
#define __conv_sdiv_19s_9nsbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_sdiv_19s_9nsbkb) {
    ...
    SC_CTOR(conv_sdiv_19s_9nsbkb):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
