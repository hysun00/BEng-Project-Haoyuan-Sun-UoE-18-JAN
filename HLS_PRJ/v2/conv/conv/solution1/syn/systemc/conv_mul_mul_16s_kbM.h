...
// ==============================================================
#ifndef __conv_mul_mul_16s_kbM__HH__
#define __conv_mul_mul_16s_kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_16s_kbM) {
    ...
    SC_CTOR(conv_mul_mul_16s_kbM):  ACMP_smul_su_U ("ACMP_smul_su_U") {
