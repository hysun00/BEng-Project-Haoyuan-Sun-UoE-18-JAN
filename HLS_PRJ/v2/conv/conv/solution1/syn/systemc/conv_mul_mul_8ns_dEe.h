...
// ==============================================================
#ifndef __conv_mul_mul_8ns_dEe__HH__
#define __conv_mul_mul_8ns_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_8ns_dEe) {
    ...
    SC_CTOR(conv_mul_mul_8ns_dEe):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
