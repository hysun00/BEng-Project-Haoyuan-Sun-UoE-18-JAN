...
// ==============================================================
#ifndef __conv_mul_mul_8ns_lbW__HH__
#define __conv_mul_mul_8ns_lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_8ns_lbW) {
    ...
    SC_CTOR(conv_mul_mul_8ns_lbW):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
