...
// ==============================================================
#ifndef __conv_urem_48ns_16cud__HH__
#define __conv_urem_48ns_16cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_urem_48ns_16cud) {
    ...
    ACMP_urem_seq<ID, 52, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_urem_seq_U;

    SC_CTOR(conv_urem_48ns_16cud):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
