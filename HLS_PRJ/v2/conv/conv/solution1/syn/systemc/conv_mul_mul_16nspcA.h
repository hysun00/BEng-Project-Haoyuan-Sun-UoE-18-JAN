...
// ==============================================================
#ifndef __conv_mul_mul_16nspcA__HH__
#define __conv_mul_mul_16nspcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_16nspcA) {
    ...
    SC_CTOR(conv_mul_mul_16nspcA):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
