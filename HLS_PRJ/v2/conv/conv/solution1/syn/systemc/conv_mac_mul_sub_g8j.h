...
// ==============================================================
#ifndef __conv_mac_mul_sub_g8j__HH__
#define __conv_mac_mul_sub_g8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mac_mul_sub_g8j) {
    ...
    SC_CTOR(conv_mac_mul_sub_g8j):  simcore_mac_0_U ("simcore_mac_0_U") {
