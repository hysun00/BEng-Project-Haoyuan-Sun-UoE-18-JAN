...
// ==============================================================
#ifndef __conv_mul_mul_8ns_ibs__HH__
#define __conv_mul_mul_8ns_ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_8ns_ibs) {
    ...
    SC_CTOR(conv_mul_mul_8ns_ibs):  ACMP_smul_us_U ("ACMP_smul_us_U") {
