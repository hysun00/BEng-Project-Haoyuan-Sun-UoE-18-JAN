...
void XConv_Set_feature_in_V(XConv *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv_WriteReg(InstancePtr->Axilites_BaseAddress, XCONV_AXILITES_ADDR_FEATURE_IN_V_DATA, Data);
}

u32 XConv_Get_feature_in_V(XConv *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv_ReadReg(InstancePtr->Axilites_BaseAddress, XCONV_AXILITES_ADDR_FEATURE_IN_V_DATA);
    return Data;
}

void XConv_Set_feature_in_precision_V(XConv *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv_WriteReg(InstancePtr->Axilites_BaseAddress, XCONV_AXILITES_ADDR_FEATURE_IN_PRECISION_V_DATA, Data);
}

u32 XConv_Get_feature_in_precision_V(XConv *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv_ReadReg(InstancePtr->Axilites_BaseAddress, XCONV_AXILITES_ADDR_FEATURE_IN_PRECISION_V_DATA);
    return Data;
}

void XConv_Set_W_V(XConv *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv_WriteReg(InstancePtr->Axilites_BaseAddress, XCONV_AXILITES_ADDR_W_V_DATA, Data);
}

u32 XConv_Get_W_V(XConv *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv_ReadReg(InstancePtr->Axilites_BaseAddress, XCONV_AXILITES_ADDR_W_V_DATA);
    return Data;
}

void XConv_Set_W_precision_V(XConv *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv_WriteReg(InstancePtr->Axilites_BaseAddress, XCONV_AXILITES_ADDR_W_PRECISION_V_DATA, Data);
}

u32 XConv_Get_W_precision_V(XConv *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv_ReadReg(InstancePtr->Axilites_BaseAddress, XCONV_AXILITES_ADDR_W_PRECISION_V_DATA);
    return Data;
}
...
void XConv_Set_B_V(XConv *InstancePtr, u32 Data) {
    ...
    XConv_WriteReg(InstancePtr->Axilites_BaseAddress, XCONV_AXILITES_ADDR_B_V_DATA, Data);
}
...
u32 XConv_Get_B_V(XConv *InstancePtr) {
    ...
    Data = XConv_ReadReg(InstancePtr->Axilites_BaseAddress, XCONV_AXILITES_ADDR_B_V_DATA);
    return Data;
}

void XConv_Set_B_precision_V(XConv *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv_WriteReg(InstancePtr->Axilites_BaseAddress, XCONV_AXILITES_ADDR_B_PRECISION_V_DATA, Data);
}

u32 XConv_Get_B_precision_V(XConv *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv_ReadReg(InstancePtr->Axilites_BaseAddress, XCONV_AXILITES_ADDR_B_PRECISION_V_DATA);
    return Data;
}

void XConv_Set_feature_out_V(XConv *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv_WriteReg(InstancePtr->Axilites_BaseAddress, XCONV_AXILITES_ADDR_FEATURE_OUT_V_DATA, Data);
}

u32 XConv_Get_feature_out_V(XConv *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv_ReadReg(InstancePtr->Axilites_BaseAddress, XCONV_AXILITES_ADDR_FEATURE_OUT_V_DATA);
    return Data;
}

void XConv_Set_feature_out_precision_V(XConv *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv_WriteReg(InstancePtr->Axilites_BaseAddress, XCONV_AXILITES_ADDR_FEATURE_OUT_PRECISION_V_DATA, Data);
}

u32 XConv_Get_feature_out_precision_V(XConv *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv_ReadReg(InstancePtr->Axilites_BaseAddress, XCONV_AXILITES_ADDR_FEATURE_OUT_PRECISION_V_DATA);
    return Data;
}
