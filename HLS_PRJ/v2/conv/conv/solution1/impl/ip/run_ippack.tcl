...
set solution_dir "F:/BEng_Project/HLS_PRJ/v2/conv/conv/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {conv_sdiv_19s_9nsbkb
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_AXI_F m_axi_AXI_W m_axi_gmem"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_AXI_F {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_AXI_F"
        data_width "128"
        param_prefix "C_M_AXI_AXI_F"
    ...
    m_axi_AXI_W {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_AXI_W"
        data_width "128"
        param_prefix "C_M_AXI_AXI_W"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 128 WSTRB 16 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 128 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
