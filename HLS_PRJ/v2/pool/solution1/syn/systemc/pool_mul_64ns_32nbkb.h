...
// ==============================================================
#ifndef __pool_mul_64ns_32nbkb__HH__
#define __pool_mul_64ns_32nbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pool_mul_64ns_32nbkb) {
    ...
    SC_CTOR(pool_mul_64ns_32nbkb):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
