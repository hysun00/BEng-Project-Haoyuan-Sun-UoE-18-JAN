...
set solution_dir "F:/BEng_Project/HLS_PRJ/v2/pool/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {pool_mul_64ns_32nbkb
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 ch_div_K W 0x0 "Data signal of ch_div_K" {{0 32 ch_div_K W 0 "Bit 31 to 0 Data signal of ch_div_K"}}} {0x18 height_in W 0x0 "Data signal of height_in" {{0 32 height_in W 0 "Bit 31 to 0 Data signal of height_in"}}} {0x20 width_in W 0x0 "Data signal of width_in" {{0 32 width_in W 0 "Bit 31 to 0 Data signal of width_in"}}} {0x28 height_out W 0x0 "Data signal of height_out" {{0 32 height_out W 0 "Bit 31 to 0 Data signal of height_out"}}} {0x30 width_out W 0x0 "Data signal of width_out" {{0 32 width_out W 0 "Bit 31 to 0 Data signal of width_out"}}} {0x38 Kx W 0x0 "Data signal of Kx" {{0 32 Kx W 0 "Bit 31 to 0 Data signal of Kx"}}} {0x40 Ky W 0x0 "Data signal of Ky" {{0 32 Ky W 0 "Bit 31 to 0 Data signal of Ky"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 447 II x}
