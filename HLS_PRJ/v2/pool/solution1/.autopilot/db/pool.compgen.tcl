...
# FIFO definition:
set ID 43
set FifoName fifo_w128_d8_A
set InstName stream_tp_V_V_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 47
set FifoName start_for_pool_2DdEe
set InstName start_for_pool_2DdEe_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 48
set FifoName start_for_hs2axiseOg
set InstName start_for_hs2axiseOg_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_r_TLAST { O 1 bit } out_r_TVALID { O 1 bit } out_r_TREADY { I 1 bit } } \
} "
} else {
