...
xilinx.com:hls:conv:0.0\
xilinx.com:hls:pool:0.0\
...
proc create_root_design { parentCell } {
  ...
  set conv_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:conv:0.0 conv_0 ]

  # Create instance: pool_0, and set properties
  set pool_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:pool:0.0 pool_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins pool_0/in_V_V]
  ...
  connect_bd_intf_net -intf_net conv_0_m_axi_AXI_F [get_bd_intf_pins axi_smc_1/S00_AXI] [get_bd_intf_pins conv_0/m_axi_AXI_F]
  connect_bd_intf_net -intf_net conv_0_m_axi_AXI_W [get_bd_intf_pins axi_smc_2/S00_AXI] [get_bd_intf_pins conv_0/m_axi_AXI_W]
  connect_bd_intf_net -intf_net conv_0_m_axi_gmem [get_bd_intf_pins axi_smc_3/S00_AXI] [get_bd_intf_pins conv_0/m_axi_gmem]
  connect_bd_intf_net -intf_net pool_0_out_r [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins pool_0/out_r]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces conv_0/Data_m_axi_AXI_F] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_0_HP1_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces conv_0/Data_m_axi_AXI_W] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] SEG_processing_system7_0_HP2_DDR_LOWOCM
